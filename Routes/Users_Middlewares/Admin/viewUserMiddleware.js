...
const viewUserMiddleware = {
    ...
    emailOrPhone:(req,res,next)=>{
        if(!req.query.email && !req.query.phone) return res.status(400).json({message:"search by phone number or email",error:"unable to view data"})
        next()
    },
